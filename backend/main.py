# =============================================================================
# NOTE: Auth routes (/auth/register, /auth/login, /api-clients, etc.) are kept
# intact below for the paid/hosted version. They are not used by the open
# source platform (which uses anonymous sessions — no login required).
# New platform endpoints (session, upload, compile, download…) will be added
# in Phase 0 of the build.
# =============================================================================
